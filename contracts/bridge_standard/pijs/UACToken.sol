...
contract UACToken is IERC20, IERC20Metadata, Ownable {
    ...
    function mintToken(bytes calldata data) external tradingAllowed onlyOperater {
        
        MintTokenData memory mintTokenData = parseMintTokenData(data);
        require(sellFeeReceiver != address(0), "UnionBridgeSource: Invalid fee receiver");
        ...
        _mint(sellFeeReceiver, mintTokenData.fee); // 收手续费
