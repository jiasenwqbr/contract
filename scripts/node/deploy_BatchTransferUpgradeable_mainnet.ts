...
async function main(){
    ...
    const batchTransfer = await upgrades.upgradeProxy('0xCB590041c9bf6B0b6E0FAD5a65f794D2de97Bf0B', batchTransferFactory, { kind: 'uups' });
...
/**
 npx hardhat run ./scripts/node/deploy_BatchTransferUpgradeable_mainnet.ts --network pijs
