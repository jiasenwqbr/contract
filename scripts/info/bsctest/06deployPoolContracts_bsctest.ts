...
async function main(){
    ...
    // // const ecoMineralPool = await upgrades.upgradeProxy('0x4d25E8a0C8eAaB664aFd9186E2D4B13bc81d1A1c', factory1, { kind: 'uups' });
    ...
    // // const s1Pool = await upgrades.upgradeProxy('0x4d25E8a0C8eAaB664aFd9186E2D4B13bc81d1A1c', factory3, { kind: 'uups' });
    ...
    // // const genesisNodeDistrictDividendPool = await upgrades.upgradeProxy('0x4d25E8a0C8eAaB664aFd9186E2D4B13bc81d1A1c', factory3, { kind: 'uups' });
